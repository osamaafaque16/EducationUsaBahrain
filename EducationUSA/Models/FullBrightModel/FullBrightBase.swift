...
public class FullBrightBase: Object, Mappable {
  ...
  @objc dynamic var result: FullBrightResult?
  ...
  public func mapping(map: Map) {
    ...
    static func getFullBright(urlPath:String,parameter:[String:Any]?,vc:BaseController,completionHandler:@escaping (_ event:FullBrightBase)->Void){
        ...
        AFWrapper.shared.requestGETURLWithHeader(urlPath, parameter, header, success: { (JSONResponse) in
            ...
            print(JSONResponse)
            let eduGuides = Mapper<FullBrightBase>().map(JSONObject: JSONResponse as Any)
