...
public class EduGuidesBase: Object, Mappable {
  ...
  @objc dynamic var result: EduGuidesResult?
  ...
  public func mapping(map: Map) {
    ...
    static func getEduGuidelines(urlPath:String,parameter:[String:Any]?,vc:BaseController,completionHandler:@escaping (_ event:EduGuidesBase)->Void){
        ...
        AFWrapper.shared.requestGETURLWithHeader(urlPath, parameter, header, success: { (JSONResponse) in
            ...
            print(JSONResponse)
            let eduGuides = Mapper<EduGuidesBase>().map(JSONObject: JSONResponse as Any)
